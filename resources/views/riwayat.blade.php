...
@section('content')
    @if (session()->has('success'))
        <div id="info-popup" tabindex="-1"
            class="font-poppins popup-close bg-[#a7a7a744] overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full flex items-center justify-center">
                    ...
                    <div class="justify-between items-center pt-0 space-y-4 sm:flex sm:space-y-0">
                        <div class="items-center space-y-4 sm:space-x-4 sm:flex sm:space-y-0">
                            <button id="close-modal" type="button"
                                class="btn-close py-2 px-4 w-full text-sm font-medium  rounded-lg border border-gray-200 sm:w-auto  focus:ring-4 focus:outline-none focus:ring-primary-300  focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600 bg-primary text-white hover:bg-primary-light transition duration-300">Cancel</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="pt-20 px-10">
        <div class="my-10">
            <h1 class="text-primary font-bold text-2xl">Riwayat Pelaporan</h1>
