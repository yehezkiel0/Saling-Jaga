            ...
            @foreach ($faqs as $faq)
                <div class="mt-12 w-full">
                    <button id="dropdownDefault"
                        class="dropdown-button shadow-md flex justify-between min-w-[100%] text-black  bg-white hover:ring-2 hover:ring-primary-lighter focus:ring-2 focus:outline-none transition duration-300 focus:ring-primary-light font-semibold rounded-lg text-lg py-2.5 text-center items-center p-5"
                        type="button">
                        <p>{{ $faq->question }}</p>
                        <svg class="md:block hidden dropdown-arrow transition duration-200 ml-2 w-4 h-4" aria-hidden="true" fill="none" stroke="currentColor"
