    ...
    <div class="min-h-screen pt-20 mt-10 flex flex-col items-center">
        ...
        <div class="mt-12 ">
            <button id="dropdownDefault" data-dropdown-toggle="dropdown" class="shadow-md flex justify-between min-w-[600px] text-black  bg-white hover:ring-2 hover:ring-primary-lighter focus:ring-2 focus:outline-none transition duration-300 focus:ring-primary-light font-bold rounded-lg text-lg px-4 py-2.5 text-center items-center" type="button">
                <p>Apa definisi kekerasan seksual?</p>
            ...
            <div id="dropdown" class="z-10 w-[600px] bg-white rounded divide-y divide-gray-100 shadow-md text-justify ">
                    <p class="py-3 text-md px-5 text-gray-700 " aria-labelledby="dropdownDefault">Kekerasan Seksual adalah setiap perbuatan merendahkan, menghina, melecehkan, dan/atau menyerang tubuh, dan/atau fungsi reproduksi seseorang, karena ketimpangan relasi kuasa dan/atau gender, yang berakibat atau dapat berakibat penderitaan psikis dan/atau fisik termasuk yang mengganggu kesehatan reproduksi seseorang dan hilang kesempatan melaksanakan pendidikan dengan aman dan optimal.
                    </p>  
            </div>  
        </div>
